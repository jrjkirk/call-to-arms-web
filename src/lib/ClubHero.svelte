...
<div class="club-hero">
    ...
    {/if}
    {#if club.discord_url || club.website_url}
        <div class="club-actions">
            {#if club.discord_url}
                <a class="club-btn discord-cta" href={club.discord_url} target="_blank" rel="noopener noreferrer">
...
<style>
    ...
    /* Shared box shape/size for both buttons — Discord and website sit side by
       side, same size; only their colour differs (Discord leads, in blurple). */
    .club-btn {
        display: inline-flex;
        align-items: center;
        gap: 0.55rem;
    ...
    /* Discord is the hub of club activity — its invite is the primary CTA. */
    .discord-cta {
        background: #5865f2;
        color: #fff;
